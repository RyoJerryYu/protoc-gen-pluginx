...
var file_compatibility_proto_goTypes = []interface{}{
...
func file_compatibility_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_compatibility_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Holder); i {
			case 0:
				return &v.state
			case 1:
		...
		file_compatibility_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_compatibility_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Holder_NestedInner); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
