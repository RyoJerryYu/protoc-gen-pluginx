...
let testCases = [
  ...
  {
    name: "stringEnum_defaultConfig",
    testDir: "stringEnums",
    serverFlags: [],
  },
  {
    name: "stringEnum_allowPartial",
    testDir: "stringEnums",
    serverFlags: ["--marshal_allow_partial=true"],
  },
  {
    name: "stringEnum_useEnumNumbers",
    testDir: "stringEnums",
    serverFlags: ["--marshal_use_enum_numbers=true"],
  },
  {
    name: "stringEnum_emitUnpopulated",
    testDir: "stringEnums",
    serverFlags: ["--marshal_emit_unpopulated=true"],
  },
  {
    name: "stringEnum_emitDefaultValues",
    testDir: "stringEnums",
    serverFlags: ["--marshal_emit_default_values=true"],
  },
  {
    name: "stringEnum_unmarshalAllowPartial",
    testDir: "stringEnums",
    serverFlags: ["--unmarshal_allow_partial=true"],
  },
  {
    name: "stringEnum_unmarshalDiscardUnknown",
    testDir: "stringEnums",
    serverFlags: ["--unmarshal_discard_unknown=true"],
  }
];
