...
export enum EnumV {
  ENUM_V_ZERO = "ENUM_V_ZERO",
  ENUM_V_ONE = "ENUM_V_ONE",
  ENUM_V_TWO = "ENUM_V_TWO",
...
function createBaseEnumWrapper(): EnumWrapper {
  return { enumValue: EnumV.ENUM_V_ZERO, repeatedEnumValue: [] };
}
...
export const EnumWrapper: MessageFns<EnumWrapper> = {
  fromJSON(object: any): EnumWrapper {
    return {
      enumValue: isSet(object.enumValue)
        ? enumVFromJSON(object.enumValue)
        : EnumV.ENUM_V_ZERO,
  ...
  toJSON(message: EnumWrapper): unknown {
    const obj: any = {};
    if (message.enumValue !== EnumV.ENUM_V_ZERO) {
  ...
  fromPartial(object: DeepPartial<EnumWrapper>): EnumWrapper {
    ...
    message.enumValue = object.enumValue ?? EnumV.ENUM_V_ZERO;
