...
import (
	...
	"github.com/RyoJerryYu/protoc-gen-pluginx/tests/protoc-gen-ts-grpc-gateway-cli/integration-protoc-gen-grpc-gateway-ts/server/proto"
...
func main() {
	...
	proto.RegisterCounterServiceServer(grpcServer, &RealCounterService{})
	...
	err = proto.RegisterCounterServiceHandlerFromEndpoint(ctx, gateway, endpoint, []grpc.DialOption{
