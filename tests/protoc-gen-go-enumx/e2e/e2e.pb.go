...
var file_e2e_proto_rawDesc = []byte{
	...
	0x2a, 0x1b, 0x0a, 0x04, 0x45, 0x6e, 0x75, 0x6d, 0x12, 0x05, 0x0a, 0x01, 0x41, 0x10, 0x00, 0x12,
	0x05, 0x0a, 0x01, 0x42, 0x10, 0x01, 0x12, 0x05, 0x0a, 0x01, 0x43, 0x10, 0x02, 0x42, 0x0b, 0x5a,
...
var file_e2e_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_e2e_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_e2e_proto_goTypes = []interface{}{
	...
	(*Message)(nil),           // 3: e2e.Message
	(*EnumParent)(nil),        // 4: e2e.EnumParent
	(*EnumParent2)(nil),       // 5: e2e.EnumParent2
}
...
func file_e2e_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_e2e_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EnumParent2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
